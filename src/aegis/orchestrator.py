...
from .policy import assert_target_authorized, load_authorized_targets
...
class AegisOrchestrator:
    ...
    def run(self, cve_id: str, target_url: str, targets_file: str) -> RunState:
        state = RunState(stage="collector")

        allowed = load_authorized_targets(targets_file)
